...
/***/ "./src/block/components/FolderToolbar.tsx":
/*!************************************************!*\
  !*** ./src/block/components/FolderToolbar.tsx ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ FolderToolbar)
/* harmony export */ });
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.BlockControls, {
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToolbarGroup, {
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToolbarButton, {
        ...
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Change folder', 'rrze-faubox'),
        onClick: onToggle,
        isPressed: isEditing
      })
    })
...
/***/ "./src/block/components/FolderTree.tsx":
/*!*********************************************!*\
  !*** ./src/block/components/FolderTree.tsx ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _wordpress_icons__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @wordpress/icons */ "./node_modules/@wordpress/icons/build-module/library/rotate-right.js");
...
function FolderTree({
  ...
  var _selectedPath$split$f;
  const [currentFolders, setCurrentFolders] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)([]);
  const [breadcrumbs, setBreadcrumbs] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)([]);
  ...
  const [noFolderConfigured, setNoFolderConfigured] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)(false);
  const [indexNotBuilt, setIndexNotBuilt] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)(false);
  const [refreshing, setRefreshing] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)(false);
  const [refreshError, setRefreshError] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)(null);
  const fetchFolders = path => {
    ...
    const endpoint = path ? `/rrze-faubox/v1/folders?path=${encodeURIComponent(path)}` : '/rrze-faubox/v1/folders';
  ...
  const handleRefreshIndex = () => {
    ...
    _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_3___default()({
      ...
      if (err?.data?.status === 429) {
        setRefreshError((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Please wait 1 minute before refreshing again.', 'rrze-faubox'));
      } else {
  ...
  const handleNavigate = folder => {
    ...
    setError(false);
    _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_3___default()({
      path: `/rrze-faubox/v1/folders?path=${encodeURIComponent(folder.path)}`
    }).then(data => {
  ...
  const selectedLabel = selectedPath ? (_selectedPath$split$f = selectedPath.split('/').filter(Boolean).pop()) !== null && _selectedPath$split$f !== void 0 ? _selectedPath$split$f : selectedPath : '';
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("button", {
        ...
        children: rrze_faubox_data?.folder || (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Root', 'rrze-faubox')
      }), breadcrumbs.map((crumb, index) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("span", {
        style: {
          display: 'flex',
          alignItems: 'center'
        },
    ...
    }), indexNotBuilt && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
      style: {
        fontSize: '13px',
        marginBottom: '8px'
      },
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("p", {
        ...
        children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Folder index not built yet. Please save your FAUbox settings or refresh the index manually.', 'rrze-faubox')
        ...
        children: refreshing ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Refreshing…', 'rrze-faubox') : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Refresh index', 'rrze-faubox')
      }), refreshError && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("p", {
        style: {
          color: '#cc1818',
          marginTop: '6px',
          fontSize: '12px'
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("div", {
        ...
        children: currentFolders.map(folder => {
          ...
          return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.Fragment, {
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
              style: {
                display: 'flex',
                alignItems: 'center',
              ...
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("button", {
                ...
                title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Select this folder', 'rrze-faubox'),
                style: {
                  flexShrink: 0,
    ...
    }), selectedPath && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("p", {
      style: {
        marginTop: '10px',
        fontSize: '13px',
        color: '#007cba',
...
/* harmony import */ var _components_FolderTree__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/FolderTree */ "./src/block/components/FolderTree.tsx");
/* harmony import */ var _components_FolderToolbar__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/FolderToolbar */ "./src/block/components/FolderToolbar.tsx");
...
function Edit({
  ...
  const treeProps = {
    selectedPath: path,
    onSelect: folderPath => setAttributes({
      path: folderPath
    })
  };
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)("div", {
    ...blockProps,
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_components_FolderToolbar__WEBPACK_IMPORTED_MODULE_7__["default"], {
      isEditing: isEditing,
      onToggle: () => setIsEditing(!isEditing)
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelBody, {
        ...
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)("div", {
          ...
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_components_FolderTree__WEBPACK_IMPORTED_MODULE_6__["default"], {
            ...treeProps
          })
        })
        ...
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.__experimentalDivider, {
          margin: "3"
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.__experimentalHeading, {
          color: "#03316a",
        ...
        }), filetypeOptions.map(type => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.CheckboxControl, {
          label: type,
        ...
        }, type)), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.__experimentalDivider, {
          margin: "2"
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.SelectControl, {
    ...
    }), isInitialSetup || isEditing ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.Placeholder, {
    ...
    }) : !path ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)("p", {
      style: {
        opacity: 0.7
      },
    ...
    }) : /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)((_wordpress_server_side_render__WEBPACK_IMPORTED_MODULE_4___default()), {
      block: "rrze/faubox",
